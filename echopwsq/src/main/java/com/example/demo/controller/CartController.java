...
//        }
	...
	public String removeFromCart(@PathVariable("id") Long productId,
	    ...
	    // 使用 for-each 迴圈遍歷購物車內所有商品
	    CartItem itemToRemove = null; 
	    for (CartItem c : cart.getItems()) {
	        // 如果購物車中某個項目的商品 ID 和前端傳入的 productId 一樣
